...
(clojure.core/defn of {:arglists (quote (["java.lang.String"] ["java.lang.String" "java.util.Map"]))} (^js/JSJoda.ZoneId [^java.lang.String java-lang-String14488] (js-invoke java.time.ZoneId "of" java-lang-String14488)) (^js/JSJoda.ZoneId [^java.lang.String java-lang-String14489 ^java.util.Map java-util-Map14490] (js-invoke java.time.ZoneId "of" java-lang-String14489 java-util-Map14490)))
